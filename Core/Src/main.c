...
int main(void)
{
  ...
  while (1) {
    ...
    interval=1e6;
    mpu_dmp_get_data(&ro[0], &ro[1], &ro[2],&accel[0],&accel[1],&accel[2]);
    
    //accel除以16384得到多少个g
    id=(int)1*accel[0]*accel[0];    
    id+=(int)1*accel[1]*accel[1];
    id+=(int)1*accel[2]*accel[2];
    double totalA=id/16384.0/16384;
    printf("%d,%d,%d,%d,%d,%d,%d\n",(int)totalA,(int)ro[0],(int)ro[1],(int)ro[2],accel[0],accel[1],accel[2]);
  }
  /* USER CODE END 3 */
}
...
//   float z0,z1,z2;
//   short a0,a1,a2;
//   mpu_dmp_get_data(&z0, &z1, &z2,&a0,&a1,&a2);
//   printf("EXTI%d,%d,%d,%d,%d\n",(int)z0,(int)z1,(int)z2,a0,a1);
// }
